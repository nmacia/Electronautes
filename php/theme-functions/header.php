      ...
      <div class="container">
        ...
        <div id="nav">
          <ul id="menu">
            ...
            <li><a href="#">survey</a>
              <ul id="survey-menu" class="hidden-nav">
                <li id="esfinx"><a href="./survey.php">ESFINX</a></li>
                <li id="kremlin"><a href="./survey.php">KREMLIN</a></li>
                <li id="bigben"><a href="./survey.php">BIG BEN</a></li>
                <li id="moais"><a href="./survey.php">MOAIS</a></li>
                <li id="atonium"><a href="./survey.php">ATONIUM</a></li>
                <li id="kheops"><a href="./survey.php">KHEOPS</a></li>
              </ul>
            </li>
            <li><a href="#">sensors</a>
              <ul id="sensors-menu" class="hidden-nav">
                <li id="sensors-esfinx"><a href="./sensors.php">ESFINX</a></li>
                <li id="sensors-kremlin"><a href="./sensors.php">KREMLIN</a></li>
                <li id="sensors-bigben"><a href="./sensors.php">BIG BEN</a></li>
                <li id="sensors-moais"><a href="./sensors.php">MOAIS</a></li>
                <li id="sensors-atonium"><a href="./sensors.php">ATONIUM</a></li>
                <li id="sensors-kheops"><a href="./sensors.php">KHEOPS</a></li>
              </ul>
            </li>
